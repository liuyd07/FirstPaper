...
This 3 models derives from different
...
However, the $Q(\theta)/\theta$ function only explicitly defines the lower-limit of the convergence rate. Simulations are presented to evaluate the novel phase model. 3 Phase models are shown in Fig. \ref{Fig_Qx}, and the convergence criterion $Q(\theta)/\theta$ are shown in Fig. \ref{Fig_Qx_x}.
