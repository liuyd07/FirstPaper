...
There has been a lot of research on fault diagnosis and localization on smart grid.
Fault Diagnosis methods lack the consideration of the synchronization accuracy.
On the demand side, the expense of PMU and GPS is high.
Upcoming smart meters will not allow complicated communication wires.
Sufficient synchronous accuracy for distributed wireless network is urgent.

Synchronization works
Studies have been proposed to solve the synchronization problem in large decentralized wireless networks.\cite{Sync_Intro_InWSN_Book} Ever since NTP (Network Time Protocol) was proposed in 1988, the time synchronization has become a research focus. To fulfill the requirements of 
Traditional ones: TPSN, FTSP, RBS, Glossy, 
Do not consider the 
PCO new
other work
...
\begin{remark}
The transformation from (\ref{PCO_dynamics}) to (\ref{PCO_phase_dynamics}) is a standard practice in the study of weakly connected PCO and it is applicable to any limit-cycle oscillation function $f_i$ and $f_g$.
\end{remark}
...
X. Yu, C. Cecati, T. Dillon and M. Simoes. "The new frontier of Smart Grids.". Industrial Electronics IEEE Transection on, 2011, Sept:49-63.
...
E. Serpedin, Q.Chaudhari, "Synchronization in wireless sensor networks : Parameter estimation, performance benchmarks and protocols", 2009, Aug. 31.
...
S. Karnouskos, "Cyber-Physical Systems in the Smart Grid", Industrial Informatics (INDIN), 2011 9th IEEE International Conference on, 2011, 20-23.

\bibitem{WSN_In_SmartGrid}
V. Gungor, B. Lu, G. Hancke, "Opportunities and Challenges of Wireless Sensor Networks in Smart Grid", Industrial Electronics, IEEE Transection on, vol. 57, No. 10, pp 3557-3564, 2010.
...
Z. Galijasevic and A. Abur, "Fault Localization Using Voltage Measurements", Power Delivery, IEEE Transactions on, Vol 17, No. 2, pp441-445, 2002.

\bibitem{Voltage_sag_sync}
Y. Sillapawicharn and Y. Kumsuwan, "An Improvement of Synchronously Rotating Reference Frame Based Voltage Sag Detection for Voltage Sag Compensation Applications under Distorted Grid Voltages", IEEE PEDS, 2011

\bibitem{Voltage_sag_local_Texas}
Y. Dong, C. Zheng and M. Kezunovic, "Enhancing Accuracy While Reducing Comutation COmplexity for Voltage-Sag-Based Distribution Fault Location", Power Delivery, IEEE Transactions on, Vol.28, No.2, pp:1202-1212, 2013.
